...
class MailMessage(models.Model):
    ...
    def _gen_ai_ans(self, odoogpt, channel_id) -> str:
        ...
        raw_response = agent.process_msg(
            full_message, channel_id.id, channel_id, odoo_manager=self, odoogpt=odoogpt
        )
    ...
    def get_all_products(self):
        ...
        product_codes = {item.get("default_code") for item in product_data if item.get("default_code")}
