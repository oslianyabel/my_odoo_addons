...
class ChatMemory:
    ...
    def reduce_context(self, channel_id: str):
    ...
    def _set_ai_output(self, ai_output, channel_id: str):
    ...
    def init_chat(self, channel_id: str):
        self.set_messages([self.init_msg], channel_id)
        print(f"New chat for {channel_id}")

    def add_msg(self, message: str, role: str, channel_id: str):
        if channel_id not in self.__messages:
            self.init_chat(channel_id)
    ...
    def set_messages(self, messages: list[dict[str, str]], channel_id: str):
    ...
    def _get_ai_msg(self, channel_id: str):
    ...
    def _purge_tool_msgs(self, channel_id: str):
    ...
    def _set_tool_output(self, call_id, function_out, channel_id: str):
...
class ToolRunner:
    ...
    def run_futures(
        self, futures, tools_called, channel_id: str, chat_memory: ChatMemory
    ):
    ...
    async def run_coroutines(
        self, tools_called, tasks, channel_id: str, chat_memory: ChatMemory
    ):
...
class Agent:
    def __init__(
        ...
        self._ai_client = AIClient(api_key)  # type: ignore
        self._tool_runner = ToolRunner()

    def process_msg(
        self, message: str, channel_id: str, odoo_manager=None, odoogpt=None
    ) -> str | None:
