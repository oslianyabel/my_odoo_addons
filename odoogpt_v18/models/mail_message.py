...
class MailMessage(models.Model):
    ...
    def create(self, values_list):
        ...
        for chat in chats:
            ...
            if channel_id.is_odoogpt_chat:
                chat.with_delay()._send_message_to_odoogpt(odoogpt, channel_id)  # Linux
                # chat._send_message_to_odoogpt(odoogpt, channel_id)  # Windows
    ...
    def _gen_ai_ans(self, odoogpt, channel_id) -> str:
        ...
        raw_response = agent.process_msg(
            full_message, channel_id.id, odoo_manager=self, odoogpt=odoogpt
        )
