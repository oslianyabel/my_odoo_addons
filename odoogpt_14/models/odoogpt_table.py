...
# DeepLake deshabilitado para compatibilidad con Odoo 14
...
class OdooGPTTable(models.Model):
    ...
    # NOTA: Funcionalidad de embeddings/vectorstore deshabilitada por compatibilidad
    # Para habilitar, instalar: pip install deeplake openai
    # y descomentar el código relacionado
    ...
    def _get_tables_info(self):
        ...
        :return: dict: diccionario con nombre de tabla y descripción
        """
        all_tables = {}
